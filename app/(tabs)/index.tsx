...
const Index = () => {
  return (
    <SafeAreaView className="flex-1 bg-white">
      <FlatList className="w-full py-2 " data={offers}
        ...
        } contentContainerClassName="pb-28 px-5" ListHeaderComponent={() => (<View className="flex-between flex-row w-full my=5  px-5">
